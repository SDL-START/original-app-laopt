...
class PTDatePickerField extends FormBuilderFieldDecoration<DateTime> {
  ...
  PTDatePickerField({
    ...
    this.onFoundError,
            ...
            builder: (FormFieldState<DateTime?> field) {
              final state = field as _PTDatePickerFieldState;
  ...
  @override
  FormBuilderFieldDecorationState<FormBuilderFieldDecoration<DateTime>, DateTime> createState() =>_PTDatePickerFieldState();
}

class _PTDatePickerFieldState
    extends FormBuilderFieldDecorationState<PTDatePickerField, DateTime> {
